...
namespace BLL.Utils
{
    ...
    public static class EnumerablePagedListExtensions
    {
        ...
        public static IPagedList<T> ToPagedList<T>(this IEnumerable<T> source, int pageIndex, int pageSize,
            int indexFrom = 0, int totalCount = 0) => new PagedList<T>(source, pageIndex, pageSize, totalCount);
    ...
    {
        public static IPagedList<T> ToPagedListAsync<T>(this List<T> source, int pageIndex, int pageSize,
        ...
        public static IPagedList<T> ToPagedListMongoAsync<T>(this List<T> source, int pageIndex, int pageSize,
            long total, int indexFrom = 0, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (indexFrom > pageIndex)
            {
                throw new ArgumentException(
        ...
        public static IPagedList<T> ToPagedListElasticAsync<T>(this List<T> source, int pageIndex, int pageSize,
            long total, int indexFrom = 0, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (indexFrom > pageIndex)
            {
    ...
    public static class QueryablePageListExtensions
    {
            ...
            int pageSize, int indexFrom = 0, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var items = await source.Skip(((pageIndex - 1) - indexFrom) * pageSize).Take(pageSize)
